...
namespace Clinic.Application.Utilities
{
    public static class PersianDate
    {
        ...
        public static (string DayName, string DayNumber, string MonthName) ToShamsiParts(this DateTime dt)
        {
            ...
            var strMonthName = months[intMonth];

            // .NET days start from Sunday, so map properly:
            var strDayName = days[(int)enDayOfWeek];

            return (strDayName, intDayOfMonth.ToString(), strMonthName);
        }
